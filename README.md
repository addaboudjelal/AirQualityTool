...
Create a simple Air Quality Tool using React and Typescript that utilizes [Open AQ Platform API](https://docs.openaq.org).  It have the ability to compare the Air Quality of two or more cities.  
